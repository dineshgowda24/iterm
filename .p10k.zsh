# Generated by Powerlevel10k configuration wizard on 2021-09-02 at 21:25 IST.
...
() {
  ...
  # Transient prompt: Hide previous prompts for a cleaner terminal
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION=$'\ufb32'
